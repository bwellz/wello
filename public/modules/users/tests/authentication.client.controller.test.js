...
(function() {
	...
	describe('AuthenticationController', function() {
		...
		it('$scope.signin() should login with a correct user and password with base fridge redirect', function() {

			$httpBackend.expectGET("modules/core/views/index.client.view.html").respond();
			$httpBackend.expectGET("modules/core/views/fridges/base/index.client.view.html").respond();
			...
			expect($location.url()).toEqual('/fridge/base');
		});
		...
		it('$scope.signup() should register with correct data', function() {
			...
			expect($location.url()).toBe('/fridge/base');
		});
